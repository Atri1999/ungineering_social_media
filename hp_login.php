...
<html>
    ...
    <body>
        ...
        <div class="header">
            <div class="logo">
                <a href="http://127.0.0.1/social_media/homepage.html" class="aaaa" target="_blank">
                <div>
        ...
        <div class="status">
            <div class="st_content"> 
                <div class="put_status">
                    ...
                    <div><button class="smt">Post</button></div>
                </div>  
                <div class="row">
