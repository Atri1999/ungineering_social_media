       ...
       <!-- <div class="row1"> 
        ...
        <div class="maindiv"> 
            ...
            <div class="maindiv2">
                <div class="row4"> 
                    <div class="four"></div>
                    <div class="five"><a href="#"><h2 style="color:red;padding-top:13px;">Existing user</h2></a></div>
                    <div class="six"><a href=""><h2 class="sixhead" style="color:black;padding-top:13px;padding-left:70px;">New user</h2></a></div>
                    <div class="seven"></div>
                </div>
                <div class="row5"> 
                    <div class="eight"></div>
                ...
                <form method="post" action="registration_submit.php">
                    ...
                    <div class="row9"> 
                        <a href="#"><h3 class="new_user_login" style="color:#D76368">Existing user,Login</h3></a>
                    </div>
                    <div class="row10"> 
                    </div>
                </form>
